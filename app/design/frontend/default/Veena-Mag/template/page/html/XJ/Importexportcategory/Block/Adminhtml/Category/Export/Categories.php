 ...
 * @author     XJ 
 */
class XJ_Importexportcategory_Block_Adminhtml_Category_Export_Categories extends XJ_Importexportcategory_Block_Adminhtml_Category_Export
{
...
?>
		<script type="text/javascript">
			window.open('<?php echo Mage::getBaseUrl(Mage_Core_Model_Store::URL_TYPE_MEDIA)."export/category/categories.csv" ?>');
		</script>
<?php		
		//$this->downloadfile();
	}
	...
	{
		$file = 'var/export/category/categories.csv';
		if (file_exists($file)) {
