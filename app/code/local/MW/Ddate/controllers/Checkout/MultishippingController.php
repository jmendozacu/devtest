...
class MW_Ddate_Checkout_MultishippingController extends Mage_Checkout_MultishippingController
{
	public function shippingPostAction()
     {		
		//Zend_Debug::dump($this->getRequest()->getPost('ddate'));die;
		if($this->missing_delivery_infor($this->getRequest()->getPost('ddate'))) {
			$this->_getCheckoutSession()->addError(Mage::helper('ddate')->__('One of multiple shipping address missed delivery date information'));
            $this->_redirect('*/*/shipping');return;
		}
