...
class MW_Ddate_Model_Type_Multishipping extends Mage_Checkout_Model_Type_Multishipping {
    ...
    {	
        ...
        try {
            ...
            foreach ($orders as $order) {
                $order->place();
                $order->save();	
				$ddate=$order->getData('singleddate');
				$this->saveDdate($order->getDdate(),$order->getDtime(),$order->getDdateComment(),$order->getIncrementId());				
	...
	return true/false
	*/
	 public function saveDdate($ddate,$dtime,$ddate_comment,$id)
    {		
