...
class Vs_ShipmentSupervisor_Adminhtml_Sales_Order_ShipmentController extends Mage_Adminhtml_Controller_Sales_Shipment
{
    ...
    { 
        ...
        if (!empty($data['comment_text'])) {
            ...
            $this->_getSession()->addError($this->__('Enter the Supervisor Name'));
