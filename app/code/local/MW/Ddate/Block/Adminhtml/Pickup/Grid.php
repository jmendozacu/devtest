...
class MW_Ddate_Block_Adminhtml_Pickup_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
  ...
  protected function _prepareColumns()
  {
	...
	/*   $array_warehouse=Mage::helper('ddate')->get_warehouse_list();
	  Mage::register('mw_warehouse',$array_warehouse);	
	
	$this->addColumn('warehouse', array(
                'header'        => Mage::helper('ddate')->__('Warehouse'),
                'index'         => 'warehouse',
            	'width'         => '180px',
				'renderer'  => 'MW_Ddate_Block_Adminhtml_Dtime_Render',				
				'filter'    => 'MW_Ddate_Block_Adminhtml_Dtime_Filter',               
            )); */
  ...
  {
      return $this->getUrl('*/*/edit', array('pickup_id' => $row->getPickupId()));
  }
