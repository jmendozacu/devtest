        ...
        try {
            ...
            if ($store == -1 || $store == null || $store == "") {
                ...
                if ($service == "sidecategory") {
                    ...
                    $res = $ws_service->placeorder($custid, $products, $store, $address, $couponCode, $is_create_quote, $transid, $pmethod, $smethod, $currency, $messages, $theme,$ddate,$dtime);
                    echo $_GET["callback"] . '(' . json_encode($res) . ');';
                    ...
                    $res = $ws_service->ws_slottiming($store, $service, $custid);
                    echo $_GET["callback"] . '(' . json_encode($res) . ');';
                }
