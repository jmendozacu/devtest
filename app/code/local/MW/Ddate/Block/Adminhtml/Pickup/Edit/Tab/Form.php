...
class MW_Ddate_Block_Adminhtml_Pickup_Edit_Tab_Form extends Mage_Adminhtml_Block_Widget_Form
{
 public function __construct()
  ...
  protected function _prepareForm()
  {
      ...
      $this->setForm($form);
      $fieldset = $form->addFieldset('pickup_form', array('legend'=>Mage::helper('ddate')->__('Item information')));
      ...
      //echo Mage::helper('ddate')->getDayoff(); exit;
      ...
      if ( Mage::getSingleton('adminhtml/session')->getPickupData() )
      {
          ...
          if($pickup->getDtime()){
          	  ...
          	  $dtime->getSelect()
          	  	->where("main_table.dtime like '".$pickup->getDtime()."'")
    ...
    {
        /* $this->setChild('grid',
            $this->getLayout()->createBlock('ddate/adminhtml_pickup_edit_tab_order','ddate.grid.order')
        ); */
