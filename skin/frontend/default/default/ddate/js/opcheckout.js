...
Billing.prototype = {
    ...
    checkDelivery: function(){
        ...
        new Ajax.Request($(checkdeliveryurl).value, {
                                method: "get",
                                parameters: {zipcode : $('billing:postcode').value },
                                onSuccess: function(transport){
                                    json = transport.responseText.evalJSON();
                                    $('billing-delivery-message').update(json.message);                                         
                                    $('billing-delivery-message').setStyle({ color: json.color});                                         
                                    if (json.color=="red") {                                        
                                        $('billing-continue').disabled = true;
                                    }else{
                                        $('billing-continue').disabled = false;
                                    }
                                }
        });
