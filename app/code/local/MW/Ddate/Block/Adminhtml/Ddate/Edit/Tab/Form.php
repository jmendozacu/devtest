...
class MW_Ddate_Block_Adminhtml_Ddate_Edit_Tab_Form extends Mage_Adminhtml_Block_Widget_Form
{
 public function __construct()
  ...
  protected function _prepareForm()
  {
     ...
     /* $fieldset->addField('ampm', 'select', array(
          'label'     => Mage::helper('ddate')->__('AM/PM'),
          'name'      => 'ampm',
          'values'    => array(
              array(
                  'value'     => 0,
                  'label'     => Mage::helper('ddate')->__('PM'),
              ),

              array(
                  'value'     => 1,
                  'label'     => Mage::helper('ddate')->__('AM'),
              ),
          ),
      ));*/   
    ...
    {
        $this->setChild('grid',
            $this->getLayout()->createBlock('ddate/adminhtml_ddate_edit_tab_order','ddate.grid.order')
        );
